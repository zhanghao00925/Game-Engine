...
class Water {
public:
    Water(Texture texture, int xSize = 150, int zSize = 150, float offset = 0.05, float weight = 0.002, float damping = 0.002);
    void Reset();
    void Affect(int xPos, int zPos, float deltaY = -0.0002d);
